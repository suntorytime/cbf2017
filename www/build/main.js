...
var TabsPage = (function () {
    ...
    TabsPage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["u" /* Component */])({template:/*ion-inline-start:"/Users/suntorytime/code/cbf2017/src/pages/tabs/tabs.html"*/'<ion-tabs>\n  <ion-tab [root]="tab1Root" tabTitle="Schedule" tabIcon="list"></ion-tab>\n  <ion-tab [root]="tab2Root" tabTitle="About" tabIcon="information-circle"></ion-tab>\n  <ion-tab [root]="tab3Root" tabTitle="Social" tabIcon="md-share"></ion-tab>\n</ion-tabs>\n'/*ion-inline-end:"/Users/suntorytime/code/cbf2017/src/pages/tabs/tabs.html"*/
        }), 
...
var FirstsunPage = (function () {
    ...
    FirstsunPage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["u" /* Component */])({
            selector: 'page-firstsun',template:/*ion-inline-start:"/Users/suntorytime/code/cbf2017/src/pages/firstsun/firstsun.html"*/'<ion-header>\n\n  <ion-navbar>\n    <ion-title>Sunday</ion-title>\n  </ion-navbar>\n\n</ion-header>\n\n\n<ion-content padding>\n<p>Sunday April 15, 2018</p>\n\n <ion-list>\n   <ion-item *ngFor="let event of list" (click)="goToDetails(event)">\n     <ion-avatar item-left>\n       <img onError="this.src=\'assets/icon-2018.jpg\'" src="https://sfcherryblossom.org/wp-content/uploads/2017/ScheduleData/Images/{{event.imagename}}">\n     </ion-avatar>\n     <h2>{{event.name}}</h2>\n     <p>{{ event.startat | date: \'shortTime\' }} to {{ event.endat | date: \'shortTime\'}}</p>\n   </ion-item>\n </ion-list>\n\n</ion-content>'/*ion-inline-end:"/Users/suntorytime/code/cbf2017/src/pages/firstsun/firstsun.html"*/
        }), 
        __metadata('design:paramtypes', [__WEBPACK_IMPORTED_MODULE_1_ionic_angular__["d" /* NavController */], __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["e" /* NavParams */]])
    ], FirstsunPage);
    return FirstsunPage;
...
var SecsatPage = (function () {
    ...
    SecsatPage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["u" /* Component */])({
            selector: 'page-secsat',template:/*ion-inline-start:"/Users/suntorytime/code/cbf2017/src/pages/secsat/secsat.html"*/'<ion-header>\n  <ion-navbar>\n    <ion-title>Saturday</ion-title>\n  </ion-navbar>\n</ion-header>\n\n<ion-content padding>\n<p>Saturday April 21, 2017</p>\n\n <ion-list>\n   <ion-item *ngFor="let event of list" (click)="goToDetails(event)">\n     <ion-avatar item-left>\n       <img onError="this.src=\'assets/icon-2018.jpg\'" src="https://sfcherryblossom.org/wp-content/uploads/2017/ScheduleData/Images/{{event.imagename}}">\n     </ion-avatar>\n     <h2>{{event.name}}</h2>\n     <p>{{ event.startat | date: \'shortTime\' }} to {{ event.endat | date: \'shortTime\'}}</p>\n   </ion-item>\n </ion-list>\n\n</ion-content>'/*ion-inline-end:"/Users/suntorytime/code/cbf2017/src/pages/secsat/secsat.html"*/
        }), 
        __metadata('design:paramtypes', [__WEBPACK_IMPORTED_MODULE_1_ionic_angular__["d" /* NavController */], __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["e" /* NavParams */]])
    ], SecsatPage);
    return SecsatPage;
...
var SecsunPage = (function () {
    ...
    SecsunPage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["u" /* Component */])({
            selector: 'page-secsun',template:/*ion-inline-start:"/Users/suntorytime/code/cbf2017/src/pages/secsun/secsun.html"*/'<ion-header>\n  <ion-navbar>\n    <ion-title>Sunday</ion-title>\n  </ion-navbar>\n</ion-header>\n\n<ion-content padding>\n<p>Sunday April 22, 2017</p>\n\n <ion-list>\n   <ion-item *ngFor="let event of list" (click)="goToDetails(event)">\n     <ion-avatar item-left>\n       <img onError="this.src=\'assets/icon-2018.jpg\'" src="https://sfcherryblossom.org/wp-content/uploads/2017/ScheduleData/Images/{{event.imagename}}">\n     </ion-avatar>\n     <h2>{{event.name}}</h2>\n     <p>{{ event.startat | date: \'shortTime\' }} to {{ event.endat | date: \'shortTime\'}}</p>\n   </ion-item>\n </ion-list>\n\n</ion-content>'/*ion-inline-end:"/Users/suntorytime/code/cbf2017/src/pages/secsun/secsun.html"*/
        }), 
        __metadata('design:paramtypes', [__WEBPACK_IMPORTED_MODULE_1_ionic_angular__["d" /* NavController */], __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["e" /* NavParams */]])
    ], SecsunPage);
    return SecsunPage;
...
var MyApp = (function () {
    ...
    MyApp = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["u" /* Component */])({template:/*ion-inline-start:"/Users/suntorytime/code/cbf2017/src/app/app.html"*/'<ion-nav [root]="rootPage"></ion-nav>\n'/*ion-inline-end:"/Users/suntorytime/code/cbf2017/src/app/app.html"*/,
        }), 
